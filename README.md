# pegasus Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a pegasus Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord]()
***
## Requirements
1) **1,000 pegasus coins.**
...
`wget -N https://raw.githubusercontent.com/AstaClover/peginnstall/master/installpegasus.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash installpegasus.sh`
...
***Step 1***
* Download and install the pegasus wallet [here](https://pegasus.to/)
***

***Step 2***
* Send EXACLY **10,000** pegasus to a receive address within your wallet.
***
